...
public class Quiz extends JFrame implements ActionListener
{
    ...
    { this.name=name;
      ...
      opt3= new JRadioButton();
       ...
       groupoptions=new ButtonGroup(); //adding all button to the group so that for slecting one option at a time.
             ...
             { ans_given=1;
                 if (groupoptions.getSelection()==null)
               {
                   useranswers[count][0]="";
                    ...
                    {
                        if(useranswers[i][0].equals(answers[i][1]))//string comparison the actul answer ans the anaswer tht user has marked.
